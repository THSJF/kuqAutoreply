...
public class ConfigManager {
    ...
    public ConfigManager() {
        try {
            ...
            qqAllowPass.addAll(listQQJavaBean.qqList);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void addQQNotReply(Long QQnumber) {
        for (long iterableElement : configJavaBean.QQNotReply) {
            if (iterableElement == QQnumber) {
                return;
            }
        }
    ...
    public void addWordNotReply(String content) {
        for (String iterableElement : configJavaBean.wordNotReply) {
            if (iterableElement.equals(content)) {
                return;
            }
        }
